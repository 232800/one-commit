...
public class ServletUtil {
    ...
    public void poiExcelServletInit() {
        resp.setContentType("application/vnd.ms-excel");//输出excel文件
     ...
     * 客户端输出二进制流
     */
    public static void setOctetStreamHeader(HttpServletResponse response, String fileName) {
        try {
            String encodedfileName = new String(fileName.getBytes(), "ISO8859-1");
